...
function createContainers() {
    ...
    var stringContainer = '<div id="'+stringLayerOrDomain+'-%containerid%" class="%roworcolumn% '+stringLayerOrDomain+'"><div class="name name-container"><h4>%name%</h4></div><div class="description description-container"><p>%description%</p></div>';
    var stringSubContainer = '<div id="sub'+stringLayerOrDomain+'-%containerid%" class="row col sub'+stringLayerOrDomain+'"><div class="name name-subcontainer"><h4>%name%</h4></div>';
...
function createCapabilities(container) {
    ...
    var stringCapabilityL1 = '<div id="capability-l1-%id%" class="row capabilityl1" onmouseover="setDescription(\'%id%\', \'hover\')" onclick="setDescription(\'%id%\', \'click\')"><div class="name name-capabilityl1"><h5>%name%</h5></div><div class="description description-capabilityl1"><p>%description%</p></div>';
    ...
    var stringCapabilityL1 = '<div id="capability-l1-%id%" class="row capabilityl1" onmouseover="setDescription(\'%id%\', \'hover\')" onclick="setDescription(\'%id%\', \'click\')"><div class="name name-capabilityl1"><h5>%name%</h5></div>';
    ...
    var stringCapabilityL1 = '<div id="capability-l1-%id%" class="row capability capabilityl1 align-middle" data-capability="%id%"><div class="name name-capabilityl1 align-middle"><h5>%name%</h5></div>';
    var stringCapabilityL2 = '<div id="capability-l2-%id%" class="row capability capabilityl2 align-middle" data-capability="%id%"><div class="name name-capabilityl2 align-middle"><h6>%name%</h6></div></div>';
...
function setDescription(capabilityId, event) {
    ...
    var result = allData.capabilities.filter(
        function(data) {
