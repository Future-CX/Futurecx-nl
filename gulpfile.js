...
gulp.task('cssBundle', () => {
	//const cssBundle = () =>
	//	src(['assets/vendor/boxicons/css/boxicons.min.css', 'assets/vendor/swiper/swiper-bundle.min.css'])
...
gulp.task('clean', () => {
	return del([path.css, path.js + '/theme.min.js', path.js + '/vendors.js', path.vendor]);
});
